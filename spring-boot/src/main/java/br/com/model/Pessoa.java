...
public class Pessoa implements Serializable {
	...
	private static final long serialVersionUID = 8708038491114890054L;
	...
	@NotNull(message = "Campo sobrenome está vazio")
	private String sobrenome;

	@Min(value = 18, message = "Somente maiores de 18 anos podem se cadastrar")
	private int idade;

	@OneToMany(fetch = FetchType.EAGER, mappedBy = "pessoa", orphanRemoval = true, cascade = CascadeType.ALL)
